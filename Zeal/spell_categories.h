...
static constexpr std::array<SpellCatEntry, 2151> spell_cat_lut = {{
    ...
    {637, {123, 127}},                              // Zephyr: Cobalt Scar,
    {638, {123, 5}},                                // Zephyr: Commons,
    {639, {123, 57}},                               // Zephyr: Dawnshroud,
    ...
    {887, {123, 54}},                               // Zephyr: Emerald Jungle,
    {888, {123, 5}},                                // Zephyr: Feerrott,
    {889, {123, 127}},                              // Zephyr: Great Divide,
    {890, {123, 57}},                               // Zephyr: Grimling,
    {891, {123, 127}},                              // Zephyr: Iceclad,
    ...
    {1233, {123, 5}},                               // Zephyr: Misty,
    {1234, {123, 57}},                              // Zephyr: Nexus,
    {1235, {123, 5}},                               // Zephyr: North Karana,
    {1236, {123, 116}},                             // Zephyr: Knowledge,
    {1237, {123, 5}},                               // Zephyr: Surefall,
    {1238, {123, 54, "Zephyr: Skyfire"}},           // Zephyr: Skyfire (db has Zepyhr).
    {1239, {123, 5}},                               // Zephyr: South Ro,
    {1244, {25, 0}},                                // Magi Bolt,
    {1245, {25, 38}},                               // Magi Strike,
    {1247, {25, 58}},                               // Magi Circle,
    {1248, {123, 36}},                              // Zephyr: Steamfont,
    {1249, {123, 67}},                              // Zephyr: Toxxulia,
    {1250, {123, 57}},                              // Zephyr: Twilight,
    ...
    {1326, {123, 54, "Ring of Combines"}},          // Ring of the Combines,
    ...
    {1376, {125, 16}},                              // Shroud of Undeath,
    {1377, {95, 7}},                                // Primal Avatar,
    {1382, {18, 109}},                              // Summon Holy Ale of Brell,
    {1384, {123, 127}},                             // Zephyr: Wakening,
    {1387, {123, 67}},                              // Zephyr: Stonebrunt,
    ...
    {1517, {123, 54, "Circle of Combines"}},        // Circle of the Combines,
    {1518, {42, 42}},                               // Remedy,
    ...
    {1736, {123, 54, "Succor: Skyfire"}},           // Wind of the North,
    {1737, {123, 54, "Succor: Emerald Jungle"}},    // Wind of the South,
    {1738, {123, 54, "Evacuate: Skyfire"}},         // Tishan's Relocation,
    {1739, {123, 54, "Evacuate: Emerald Jungle"}},  // Markar's Relocation,
    ...
    {2432, {123, 57, "Circle of Nexus"}},           // Circle of the Nexus,
    {2433, {123, 57, "Ring of Nexus"}},             // Ring of the Nexus,
    {2434, {95, 7}},                                // Avatar,
...
// Alternative categorization for transport spells.
struct TransportEntry {
  int spell_id;
  int transport_type;  // Subcategory for 123.
  constexpr TransportEntry(int _spell_id, int _transport_type) : spell_id(_spell_id), transport_type(_transport_type){};
};

static constexpr std::array<TransportEntry, 157> alt_transport_lut = {{
    {36, 164},    // Gate,
    {523, 166},   // Zephyr: Butcher,
    {530, 164},   // Ring of Karana,
    {531, 164},   // Ring of Commons,
    {532, 164},   // Ring of Butcher,
    {533, 164},   // Ring of Toxxulia,
    {534, 164},   // Ring of Lavastorm,
    {535, 164},   // Ring of Ro,
    {536, 164},   // Ring of Feerrott,
    {537, 164},   // Ring of Steamfont,
    {538, 164},   // Ring of Misty,
    {541, 164},   // Tox Gate,
    {542, 164},   // North Gate,
    {543, 164},   // Fay Gate,
    {544, 164},   // Common Gate,
    ...
    {547, 164},   // Ro Gate,
    {548, 164},   // West Gate,
    {550, 165},   // Circle of Karana,
    {551, 165},   // Circle of Commons,
    {552, 165},   // Circle of Toxxulia,
    {553, 165},   // Circle of Butcher,
    {554, 165},   // Circle of Lavastorm,
    {555, 165},   // Circle of Ro,
    {556, 165},   // Circle of Feerrott,
    {557, 165},   // Circle of Steamfont,
    {558, 165},   // Circle of Misty,
    {561, 165},   // Tox Portal,
    {562, 165},   // North Portal,
    {563, 165},   // Fay Portal,
    {564, 165},   // Nek Portal,
    {565, 165},   // Cazic Portal,
    {566, 165},   // Common Portal,
    {567, 165},   // Ro Portal,
    {568, 165},   // West Portal,
    {602, 165},   // Evacuate: North,
    {603, 165},   // Evacuate: Fay,
    {604, 165},   // Evacuate: Ro,
    {605, 165},   // Evacuate: Nek,
    {606, 165},   // Evacuate: West,
    {607, 165},   // Succor: East,
    {608, 165},   // Succor: Butcher,
    {609, 165},   // Succor: Ro,
    {610, 165},   // Succor: Lavastorm,
    {611, 165},   // Succor: North,
    {637, 166},   // Zephyr: Cobalt Scar,
    {638, 166},   // Zephyr: Commons,
    {639, 166},   // Zephyr: Dawnshroud,
    {666, 165},   // Alter Plane: Hate,
    {674, 165},   // Alter Plane: Sky,
    {751, 166},   // Zephyr: Combines,
    {852, 166},   // Zephyr: East Karana,
    {887, 166},   // Zephyr: Emerald Jungle,
    {888, 166},   // Zephyr: Feerrott,
    {889, 166},   // Zephyr: Great Divide,
    {890, 166},   // Zephyr: Grimling,
    {891, 166},   // Zephyr: Iceclad,
    {1023, 166},  // Zephyr: Lavastorm,
    {1233, 166},  // Zephyr: Misty,
    {1234, 166},  // Zephyr: Nexus,
    {1235, 166},  // Zephyr: North Karana,
    {1236, 166},  // Zephyr: Knowledge,
    {1237, 166},  // Zephyr: Surefall,
    {1238, 166},  // Zephyr: Skyfire,
    {1239, 166},  // Zephyr: South Ro,
    {1248, 166},  // Zephyr: Steamfont,
    {1249, 166},  // Zephyr: Toxxulia,
    {1250, 166},  // Zephyr: Twilight,
    {1325, 164},  // Combine Gate,
    {1326, 164},  // Ring of the Combines,
    {1334, 165},  // Translocate: Group,
    {1336, 166},  // Translocate: Fay,
    {1337, 166},  // Translocate: Tox,
    {1338, 166},  // Translocate: North,
    {1339, 166},  // Translocate: Combine,
    {1371, 166},  // Translocate: Nek,
    {1372, 166},  // Translocate: Common,
    {1373, 166},  // Translocate: Ro,
    {1374, 166},  // Translocate: West,
    {1375, 166},  // Translocate: Cazic,
    {1384, 166},  // Zephyr: Wakening,
    {1387, 166},  // Zephyr: Stonebrunt,
    {1398, 165},  // Circle of Wakening Lands,
    {1399, 165},  // Wakening Lands Portal,
    {1417, 164},  // Iceclad Gate,
    {1418, 165},  // Iceclad Portal,
    {1422, 166},  // Translocate,
    {1423, 165},  // Great Divide Portal,
    {1425, 165},  // Cobalt Scar Portal,
    {1433, 164},  // Ring of Iceclad,
    {1434, 165},  // Circle of Iceclad,
    {1438, 165},  // Circle of Great Divide,
    {1440, 165},  // Circle of Cobalt Scar,
    {1516, 165},  // Combine Portal,
    {1517, 165},  // Circle of the Combines,
    {1566, 164},  // Egress,
    {1567, 165},  // Succor,
    {1626, 164},  // Levant,
    {1627, 164},  // Abscond,
    {1628, 165},  // Evacuate,
    {1736, 165},  // Wind of the North,
    {1737, 165},  // Wind of the South,
    {1738, 165},  // Tishan' s Relocation,
    {1739, 165},  // Markar's Relocation,
    {1771, 166},  // Call of the Hero,
    {2020, 165},  // Circle of Surefall Glade,
    {2021, 164},  // Ring of Surefall Glade,
    {2022, 166},  // Translocate: Iceclad,
    {2023, 166},  // Translocate: Great Divide,
    {2024, 166},  // Translocate: Wakening Lands,
    {2025, 166},  // Translocate: Cobalt Scar,
    {2026, 164},  // Great Divide Gate,
    {2027, 164},  // Wakening Lands Gate,
    {2028, 164},  // Cobalt Scar Gate,
    {2029, 164},  // Ring of Great Divide,
    {2030, 164},  // Ring of Wakening Lands,
    {2031, 164},  // Ring of Cobalt Scar,
    {2183, 165},  // Lesser Succor,
    {2184, 165},  // Lesser Evacuate,
    {2417, 164},  // Ring of Grimling,
    {2418, 164},  // Grimling Gate,
    {2419, 165},  // Circle of Grimling,
    {2420, 165},  // Grimling Portal,
    {2421, 166},  // Translocate: Grimling,
    {2422, 164},  // Ring of Twilight,
    {2423, 164},  // Twilight Gate,
    {2424, 165},  // Circle of Twilight,
    {2425, 165},  // Twilight Portal,
    {2426, 166},  // Translocate: Twilight,
    {2427, 164},  // Ring of Dawnshroud,
    {2428, 164},  // Dawnshroud Gate,
    {2429, 165},  // Circle of Dawnshroud,
    {2430, 165},  // Dawnshroud Portal,
    {2431, 166},  // Translocate: Dawnshroud,
    {2432, 165},  // Circle of the Nexus,
    {2433, 164},  // Ring of the Nexus,
    {2558, 166},  // Decession,
    {2734, 164},  // The Nexus,
    {2943, 166},  // Translocate: Nexus,
    {2944, 165},  // Nexus Portal,
    {2945, 164},  // Nexus Gate,
    {3134, 164},  // Portal of Knowledge,
    {3180, 165},  // Knowledge Portal,
    {3181, 166},  // Translocate: Knowledge,
    {3182, 164},  // Ring of Knowledge,
    {3183, 164},  // Knowledge Gate,
    {3184, 165},  // Circle of Knowledge,
    {3243, 167},  // Teleport,
    {3244, 166},  // Greater Decession,
    {3792, 165},  // Circle of Stonebrunt,
    {3793, 165},  // Stonebrunt Portal,
    {3794, 164},  // Ring of Stonebrunt,
    {3795, 164},  // Stonebrunt Gate,
    {3833, 166},  // Translocate: Stonebrunt,
    {3849, 165},  // Alter Plane: Hate II,
    {3921, 164},  // Guide Evacuation,
}};

SpellCat getSpellCategoryAndSubcategory(int spellID, bool use_alt_transport) {
  ...
  if (it != spell_cat_lut.end() && it->spell_id == spellID) {
    auto spell_cat = it->spell_cat;
    if (it->spell_cat.Category == 123 && use_alt_transport) {
      // Look up the alternative sub-categorization for transport spells.
      auto alt_it = std::lower_bound(alt_transport_lut.begin(), alt_transport_lut.end(), spellID,
                                     [](const TransportEntry &entry, int value) { return entry.spell_id < value; });
      if (alt_it != alt_transport_lut.end() && alt_it->spell_id == spellID)
        spell_cat.SubCategory = alt_it->transport_type;
    }
    return spell_cat;
  }
...
static inline std::string GetSpellSubCategoryName(DWORD subcategoryID) {
  switch (subcategoryID) {
    ...
    case 163:
      return "Alaris";
    case 164:  // Alternative transport subcategories.
      return "Self";
    case 165:
      return "Group";
    case 166:
